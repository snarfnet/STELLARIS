...
VERSION_META = {
    "description": (
        "STELLARISは、音作り、演奏、シーケンスを3つの画面で扱うシンセサイザーアプリです。\n\n"
        "波形、フィルター、エンベロープ、LFO、XYパッド、ステップシーケンサーを使い、音を作ってそのまま演奏できます。"
        "惑星が衝突する瞬間のようなUIで、暗い宇宙と光の境界を触りながら音を変えていけます。"
    ),
    "keywords": "シンセサイザー,音楽制作,演奏,シーケンサー,音作り,電子音楽,鍵盤,LFO",
    "promotionalText": "音作り、演奏、シーケンスをひとつのシンセ空間で。",
