...
BUNDLE_ID = os.environ.get("APP_BUNDLE_ID", "com.tokyonasu.STELLARIS")
APP_NAME = os.environ.get("APP_NAME", "STELLARIS")
DEV_BUNDLE_NAME = os.environ.get("DEV_BUNDLE_NAME", "STELLARIS")
APP_SKU = os.environ.get("APP_SKU", "STELLARIS2026")
